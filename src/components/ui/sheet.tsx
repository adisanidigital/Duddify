...
>(({ side = "right", className, children, ...props }, ref) => {
  const sides = {
    ...
    right:
      "right-0 top-0 h-full w-3/4 max-w-sm border-l data-[state=open]:slide-in-from-right data-[state=closed]:slide-out-to-right",
    top: "top-0 inset-x-0 border-b data-[state=open]:slide-in-from-top data-[state=closed]:slide-out-to-top",
    bottom:
      "bottom-0 inset-x-0 border-t rounded-t-2xl data-[state=open]:slide-in-from-bottom data-[state=closed]:slide-out-to-bottom",
  } as const;
  return (
    <SheetPortal>
      <SheetOverlay />
